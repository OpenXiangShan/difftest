...
PLDM_BUILD_DIR 		 = $(abspath $(NOOP_HOME)/pldm-build)
...
PLDM_MACRO_FLAGS 	+= +define+DIFFTEST +define+DISABLE_DIFFTEST_RAM_DPIC +define+DISABLE_SIMJTAG_DPIC +define+DIFFTEST_DEFERRED_RESULT
endif
...
# Verilog Files
PLDM_VSRC_DIR  	 = $(BUILD_DIR)
ifeq ($(SYNTHESIS), 1)
PLDM_VSRC_DIR 	+= $(abspath ./src/test/vsrc/vcs) $(abspath ./src/test/vsrc/common/SimJTAG.sv)
else
...
PLDM_CXXFILES 	 = $(SIM_CXXFILES) $(DIFFTEST_CXXFILES) $(GEN_CXXFILES) $(PLUGIN_DASM_CXXFILES) $(shell find $(PLDM_CSRC_DIR) -name "*.cpp")
PLDM_CXXFLAGS 	 = -m64 -c -fPIC -g -std=c++11 -I$(PLDM_IXCOM) -I$(PLDM_SIMTOOL)
PLDM_CXXFLAGS   += -I$(CFG_DIR) -I$(SIM_CSRC_DIR) -I$(DIFFTEST_CSRC_DIR) -I$(PLUGIN_DASM_DIR) -I$(GEN_CSRC_DIR)
PLDM_CXXFLAGS 	+= $(SIM_CXXFLAGS) -I$(PLDM_CSRC_DIR) -DNUM_CORES=$(NUM_CORES)
PLDM_CXXFLAGS   += -DREF_PROXY=SpikeProxy -DSELECTEDSpike -DPALLADIUM
ifneq ($(SYNTHESIS), 1)
  PLDM_CXXFLAGS += -DDIFFTEST_DEFERRED_RESULT
endif
