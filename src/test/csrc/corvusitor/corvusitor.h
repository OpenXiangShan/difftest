...
#ifndef __SIMULATOR_CORVUSITOR_H
#define __SIMULATOR_CORVUSITOR_H
...
class CorvusitorSim final : public Simulator {
private:
  VCorvusTopWrapper *dut;
...
#endif // __SIMULATOR_CORVUSITOR_H
