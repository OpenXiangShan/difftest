...
VCS_CXXFLAGS += -std=c++14 -static -Wall -I$(VCS_CSRC_DIR) -I$(SIM_CSRC_DIR) -I$(DIFFTEST_CSRC_DIR) -I$(PLUGIN_CHEAD_DIR)
VCS_LDFLAGS  += -lpthread -lSDL2 -ldl -lz -lsqlite3 /usr/lib/x86_64-linux-gnu/libboost_filesystem.a
