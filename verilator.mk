...
VERILATOR_4_210 = $(shell expr `verilator --version | cut -f2 -d " " | tr -d .` \>= 4210)
VERILATOR_5_000 = $(shell expr `verilator --version | cut -f2 -d " " | tr -d .` \>= 5000)
ifeq ($(VERILATOR_4_210),1)
EMU_CXXFLAGS += -DVERILATOR_4_210
VEXTRA_FLAGS += --instr-count-dpi 1
endif
ifeq ($(VERILATOR_5_000),1)
EMU_CXXFLAGS += -DVERILATOR_5_000
